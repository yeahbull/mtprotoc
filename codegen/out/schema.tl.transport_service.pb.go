...
func (*TLRpcDropAnswer) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*TLGetFutureSalts) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{1} }
...
func (*TLPing) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{2} }
...
func (*TLPingDelayDisconnect) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{3} }
...
func (*TLDestroySession) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{4} }
...
func (*TLContestSaveDeveloperInfo) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{5} }
...
func init() { proto.RegisterFile("schema.tl.transport_service.proto", fileDescriptor7) }
